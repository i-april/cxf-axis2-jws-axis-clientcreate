 ...
 * 
 */
@WebServiceClient(name = "MainService", targetNamespace = "http://ws.sitech.com", wsdlLocation = "http://192.130.228.17:9099/adapter/services/wsadapter?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAINSERVICE_QNAME = new QName("http://ws.sitech.com", "MainService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.130.228.17:9099/adapter/services/wsadapter?wsdl");
     ...
     * 
     * @return
     *     returns MainServicePortType
     */
    @WebEndpoint(name = "MainServicePort")
    public MainServicePortType getMainServicePort() {
        return super.getPort(new QName("http://ws.sitech.com", "MainServicePort"), MainServicePortType.class);
    }
     ...
     */
    @WebEndpoint(name = "MainServicePort")
    public MainServicePortType getMainServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.sitech.com", "MainServicePort"), MainServicePortType.class, features);
    }
