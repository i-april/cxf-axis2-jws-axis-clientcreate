...
public class MainServiceLocator extends org.apache.axis.client.Service implements axis.MainService {
    ...
    private java.lang.String MainServicePort_address = "http://192.168.228.2:9099/adapter/services/wsadapter";
    ...
    public axis.MainServicePortType getMainServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public axis.MainServicePortType getMainServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            axis.MainServiceBingdingStub _stub = new axis.MainServiceBingdingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (axis.MainServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                axis.MainServiceBingdingStub _stub = new axis.MainServiceBingdingStub(new java.net.URL(MainServicePort_address), this);
                _stub.setPortName(getMainServicePortWSDDServiceName());
                return _stub;
            }
        }
